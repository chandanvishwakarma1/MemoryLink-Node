        ...
        <>
            <View className='flex-1 mx-6'>
                ...
                <View className='gap-3 mt-6'>
                    <View className='flex-row justify-between items-center border border-neutral-300 py-6 px-4 rounded-lg gap-3'>
                    ...
                    <View className='flex-row  justify-between items-center border border-neutral-300 py-6 px-4 rounded-lg overflow-hidden gap-3'>
                ...
                {/* true isLoading */}
                <TouchableOpacity onPress={handleNext} disabled={isLoading} className='flex-row px-6 h-16 bg-blue-600  rounded-xl w-full shadow-lg justify-center items-center mt-6'>
                    {isLoading ?
