...
export default function Login() {
  ...
  return (
    ...
    >
      ...
      <View className='flex mt-3 items-center'><Text>Don't have an account yet? <Link href="/(auth)/(register)/choice"><Text className='text-blue-600 font-semibold'>Sign Up</Text></Link></Text></View>
    </KeyboardAvoidingView>
  )
}
